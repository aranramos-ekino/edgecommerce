...
## Environments
- Preview: https://main--edgecommerce--aranramos-ekino.aem.page/
- Live: https://main--edgecommerce--aranramos-ekino.aem.live/
...
1. Open the `edgecommerce` directory in your favourite IDE and start coding :)
